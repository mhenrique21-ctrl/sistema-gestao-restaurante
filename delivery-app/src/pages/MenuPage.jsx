    ...
    <button onClick={onClick}
      ...
      <div className="flex-1 min-w-0 flex flex-col">
        {product.promo_price != null ? (
          ...
          <span className="badge-soft badge-danger self-start mb-1.5">
            🎉 Promoção
          </span>
        ) : null}
        ...
        <div className="px-5 pt-4 pb-3 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2 flex-shrink-0">
            <a href="https://wa.me/5596974007410" target="_blank" rel="noopener noreferrer"
              title="Fale conosco no WhatsApp" className="press w-11 h-11 rounded-full flex items-center justify-center"
